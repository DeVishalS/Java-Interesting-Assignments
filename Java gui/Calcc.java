...
class Calcc extends WindowAdapter implements ActionListener 
...
public void result()
{ Float result=0.0f;int i1=0,i2=0,i=0;String r; 
  while(oper.indexOf("*")!=-1||oper.indexOf("/")!=-1)
 {  i1=oper.indexOf("*");i2=oper.indexOf("/");if(i1==-1)i1=999;if(i2==-1)i2=999;
     if(i1<i2) { result=opnd.elementAt(i1)*opnd.elementAt(i1+1); i=i1;}
 else{result=opnd.elementAt(i2)/opnd.elementAt(i2+1);i=i2;}
